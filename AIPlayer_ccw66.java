public class AIPlayer_ccw66 implements Player{
    ...
    shipsize:for(int k = 0; k < shipSize.length; ++k){
        int rowTop = (int)(Math.random() * 9) + 1;
        ...
        int columnTop = (int)(Math.random() * 9) + 1;
        ...
        double placementNum = Math.random();
        if (placementNum > .5)
            placement = 'v';
        else
            placement = 'h';
    ...
    public Coordinate fire(){
        ...
        Coordinate x = new Coordinate((int)(Math.random() * 9) + 1,(int)(Math.random() * 9) + 1);
        
        while(x.y < 0 || x.y > 9 || x.x < 0 || x.x > 9){
            System.out.println("Invalid coordinates! Guess again!");
            x = new Coordinate((int)(Math.random() * 9) + 1,  (int)(Math.random() * 9) + 1);
            continue;
        }
        return x;
